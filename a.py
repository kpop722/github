...
def difficulty_level(hardness):
    #Need to set variables as global to use them multiple times,
    #will set inputs(vocab and answers) as global
        global easy_vocab
        global medium_vocab
        global hard_vocab
...
def play():
    quiz = game_input_substitute[hardness]['vocab']
